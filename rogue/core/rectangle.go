...
type IRectangle interface {
	...
	Collides(IRectangle) bool // Collides returns true if the rectangle intersects with the other rectangle.
...
// Collides returns true if the rectangle intersects with the other rectangle.
func (r *Rectangle) Collides(other IRectangle) bool {
